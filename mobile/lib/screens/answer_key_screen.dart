        ...
        children: [
          AppCard(
            child: EmptyState(
              ...
              message:
                  'CheckWise reads the numbered items and the answer key out of '
                  'your finished questionnaire. Mark the correct answers in the '
                  'PDF — highlighted or bold — before uploading.',
...
class _QuestionCard extends StatelessWidget {
  const _QuestionCard({required this.question, required this.onEdited});
